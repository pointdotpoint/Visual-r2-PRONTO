...
<link rel="stylesheet" type="text/css" media="all" href="<c:url value='/commons/bootstrap/css/bootstrap-lumen.css'/>" />
<!--
...
<link rel="stylesheet" type="text/css" media="all" href="<c:url value='/commons/themes/menured/menu_red.css'/>" />
-->
